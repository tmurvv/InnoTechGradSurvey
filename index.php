    ...
    <header>
        <nav>                                  
            <div class="row">
                ...
                <ul class="main-nav js--main-nav">
                    ...
                    <li><button type="button" class="btn-main-nav" onclick="throwCap();">Throw your cap!</button></li>
        ...
        <div class="hero-text-box">
            ...
            <div class="row">
                ...
                <button type="button" class="col span-1-of-5 btnCap" onclick = "throwCap();" id="btnCap">Throw your cap!</button>
